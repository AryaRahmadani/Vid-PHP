...
<?php
$jumlahdata = $db->rowCOUNT("SELECT idmenu FROM dbmenu $where");
$banyak = 3;
...
$sql = "SELECT * FROM dbmenu $where ORDER BY menu ASC LIMIT $mulai,$banyak";
$row = $db->getALL($sql);
    ...
    <?php foreach ($row as $r) : ?>
        <div class="card" style="width: 15rem; float:left; margin:10px">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" href="?f=home&m=beli&id=<?php echo $r['idmenu'] ?>" role="button">Pesan</a>
            </div>
        </div>
